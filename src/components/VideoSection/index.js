...
const VideoSection = () => {
  return (
    ...
    <div className='video_item_svg'>
            ...
            <path d="M38.9385 28.2866C53.9607 36.9584 68.9061 45.5848 83.9737 54.2845C68.9131 62.9773 53.9607 71.6106 38.9385 80.2824C38.9385 62.9284 38.9385 45.6616 38.9385 28.2866Z" fill="white" fill-opacity="0.7"/>
            </svg>
